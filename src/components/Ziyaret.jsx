...
const Ziyaret = () => {
  return (
    <div className="h-[638px] grid grid-rows-3 grid-cols-4 gap-4 m-[150px] ">
      <div className=" text-manrope row-start-1 row-end-4 col-start-1 col-span-2  flex  flex-col justify-center items-center">
      ...
      {visit.map((item, index) => (
        <div
          className={`col-start-${index % 2 === 0 ? 3 : 4} col-end-${
            index % 2 === 0 ? 3 : 4
          } flex justify-center items-center font-roboto`}
          key={index}
        >
